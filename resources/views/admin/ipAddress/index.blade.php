...
@section('title')
    @lang('app.ipAddresses')
@endsection
@section('content')
    <div class="h3 mb-3">@lang('app.ipAddresses')</div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover table-sm" id="dt-table">
            ...
            <tr class="small">
                ...
                <th>@lang('app.countryCode')</th>
                <th>@lang('app.countryName')</th>
                <th>@lang('app.cityName')</th>
    ...
    <script>
        $(document).ready(function () {
            let dtTable = $('#dt-table').DataTable({
                ...
                pageLength: 50,
                ajax: {
                    url: "{{ route('admin.ipAddresses.api') }}",
                    dataType: "json",
                    type: "POST",
                ...
                $('.check-disabled').click(function () {
                    ...
                    $.ajax({
                        url: "{{ route("admin.ipAddresses.disabled") }}",
                        dataType: "json",
                        type: "POST",
