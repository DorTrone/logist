...
@section('content')
    <div class="row justify-content-center">
        <div class="col-sm-10 col-md-8 col-lg-6 col-xl-4">
            ...
            <form action="{{ route('admin.tasks.update', $obj->id) }}" method="post">
                {{ method_field('PUT') }}
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name_tm') is-invalid @enderror"
                           id="name_tm" name="name_tm" value="{{ $obj->name_tm }}">
                    @error('name_tm')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name_ru') is-invalid @enderror"
                           id="name_ru" name="name_ru" value="{{ $obj->name_ru }}">
                    @error('name_ru')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name_cn') is-invalid @enderror"
                           id="name_cn" name="name_cn" value="{{ $obj->name_cn }}">
                    @error('name_cn')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
