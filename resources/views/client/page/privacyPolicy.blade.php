...
@section('title')
    @lang('app.privacyPolicy')
@endsection
@section('content')
    <div class="container-xl py-4 py-sm-5">
        <div class="h4 text-uppercase text-center mb-3 mb-sm-4">
            @lang('app.privacyPolicy')
        </div>
        <div>
            <p>Introduction</p>
            <p>Our privacy policy will help you understand what information we collect at Shazada Logistics, how Shazada Developers uses it, and what choices you have. Shazada Developers built the Shazada Logistics app as a free app. This SERVICE is provided by Shazada Developers at no cost and is intended for use as is. If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>
            ...
            <p>Email: electshopp17@gmail.com</p>
        </div>
    </div>
@endsection
